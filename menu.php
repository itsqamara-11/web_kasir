...
$query = mysqli_query($conn, "SELECT * FROM tb_daftar_menu2 
  LEFT JOIN tb_kategori_menu ON tb_kategori_menu.id_kat_menu = tb_daftar_menu2.kategori");
      ...
      ?>
          ...
          <div class="modal fade" id="ModalView<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-fullscreen-md-down">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel">DetailMakanan & Minuman</h1>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <form class="needs-validation" novalidate action="proses/proses_input_menu.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-floating mb-3">
                          <input disabled type="text" class="form-control" id="namaMenu" name="nama_menu" value="<?php echo $row['nama_menu'] ?>" required>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-floating mb-3">
                          <input disabled type="text" class="form-control" id="keterangan" name="keterangan" value="<?php echo $row['keterangan'] ?>">
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-floating mb-3">
                          <select disabled class="form-select" id="kategoriMenu" name="kategori" required>
                            <option selected hidden value="">Pilih Kategori Menu</option>
                            <?php
                            foreach ($select_kat_menu as $value) {
                              $selected = ($row['kategori'] == $value['id_kat_menu']) ? 'selected' : '';
                              echo "<option value=\"{$value['id_kat_menu']}\" $selected>{$value['kategori_menu']}</option>";
                            }
                            ?>
                          </select>
                          <label for="kategoriMenu">Kategori Makanan atau Minuman</label>
                          <div class="invalid-feedback">
                            Pilih Kategori Makanan atau Minuman.
                          </div>
                        </div>
