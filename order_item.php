...
$query = mysqli_query($conn, "SELECT *, SUM(harga*jumlah) AS harganya, tb_orderr.waktu_order FROM tb_list_order 
  LEFT JOIN tb_orderr ON tb_orderr.id_order = tb_list_order.kode_order
...
$select_menu = mysqli_query($conn, "SELECT id,nama_menu FROM tb_daftar_menu2");
?>
          ...
          <div class="modal-dialog modal-lg modal-fullscreen-md-down">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <span class="text-danger fs-8 fw-semibold">Apakah anda yakin ingin melakukan pembayaran?</span>
...
<div id="struk">
  <h2>Struk Pembayaran Cozcafe</h2>
